...
### 页面构成
- **窗口控制器**：SettingsWindowController 单例管理 NSWindow 生命周期，窗口标题"VoKey Settings"，可关闭但不可缩放。
...
### 页面构成
- **窗口控制器**：HistoryWindowController 单例管理 NSWindow，窗口标题"VoKey 识别历史"，可关闭、缩放、最小化。
